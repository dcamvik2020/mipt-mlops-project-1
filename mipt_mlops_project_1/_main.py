...
def main():
    ...
    model, data_trn, data_tst = train_model(model_dirname=model_dir, model_fname=model_file, logging=logging_low)
    logging_print(logging=logging, line="OK")
    logging_print(logging=logging, line="-----------------------------------------")
    ...
    scores_trn, scores_tst = eval_model(data_trn, data_tst, model_dirname=model_dir, model_fname=model_file)
